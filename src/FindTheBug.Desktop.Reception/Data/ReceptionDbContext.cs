...
public class ReceptionDbContext : DbContext
{
    ...
    public override int SaveChanges()
    {
        ...
        foreach (var entry in entries)
        {
            ...
            {
                // Handle created timestamp if entity has CreatedAt
                var createdAtProperty = entry.Property("CreatedAt");
                if (createdAtProperty != null && !createdAtProperty.IsModified)
                {
                    createdAtProperty.CurrentValue = DateTime.UtcNow;
                }
            }

            // Handle updated timestamp if entity has UpdatedAt
