...
namespace FindTheBug.Application.Features.UserManagement.Users.Validators;
...
public class CreateUserCommandValidator : AbstractValidator<CreateUserCommand>
{
    public CreateUserCommandValidator()
    {
        ...
        RuleFor(x => x.Password)
            .NotEmpty().When(x => x.AllowUserLogin).WithMessage("Password is required when user login is allowed")
