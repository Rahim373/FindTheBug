...
{
    public async Task<ErrorOr<Result<List<RoleListItemDto>>>> Handle(GetActiveRolesQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result<List<RoleListItemDto>>.Success(roleDtos);
    }
}
